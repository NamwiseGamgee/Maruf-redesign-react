...
const Home = () => {
    return (
        <div>
            ...
            <div className='bg-[#00040e] flex items-center px-[100px] gap-[110px] pb-[120px]'>
                <div className='pl-12 pb-6 pt-[60px] pr-20 rounded-xl bg-[#010818]'>
            ...
            <div className='bg-[#00040e] text-center pb-20'>
                <h2 className='text-4xl font-bold text-white mb-[11px]'>My Recent Works</h2>
                <hr className='mx-auto border-none w-[84px] bg-[#ffb444] h-1' />
            </div>
            <div className='flex gap-5 bg-[#00040e] items-center px-[100px] justify-center pb-[121px]'>
            ...
            <div className='flex px-[100px] justify-around items-center bg-[#00040e] pb-[120px]'>
